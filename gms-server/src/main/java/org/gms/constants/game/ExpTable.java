...
public final class ExpTable {
    public static final int MAX_PLAYER_LEVEL = 250;
    private static final int POST_200_EXP_INCREMENT = 8_000_000;
    private static final int POST_200_EXP_CAP = 2_100_000_000;
    ...
    public static int getExpNeededForLevel(int level) {
        ...
        long post200Exp = exp[exp.length - 1]
                + (long) (level - (exp.length - 1)) * POST_200_EXP_INCREMENT;
        return (int) Math.min(post200Exp, POST_200_EXP_CAP);
    }
