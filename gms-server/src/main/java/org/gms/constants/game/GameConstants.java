...
public class GameConstants {
    ...
    public static final String[] stats = {"tuc", "reqLevel", "reqJob", "reqSTR", "reqDEX", "reqINT", "reqLUK", "reqPOP", "cash", "cursed", "success", "setItemID", "equipTradeBlock", "durability", "randOption", "randStat", "masterLevel", "reqSkillLevel", "elemDefault", "incRMAS", "incRMAF", "incRMAI", "incRMAL", "incRMAH", "canLevel", "skill", "charmEXP"};
    ...
    public static int getJobMaxLevel(Job job) {
        ...
        switch (jobBranch) {
            ...
            default:
                return ExpTable.MAX_PLAYER_LEVEL;
        }
    }
